...
class PlayerTest {
	...
	public void testStatusCalculating() {
		...
		assertAll(
				() -> assertEquals(0, beforePutDices, "it should be zero because there was no game yet"),
	...
	public void testPlayerToJson() {
		...
		assertAll(
				() -> assertEquals(player.getId(), jsonToCompare.getId(), msgError("Id")),
				() -> assertEquals(player.getEmail(), jsonToCompare.getEmail(), msgError("E-mail")),
				() -> assertEquals(player.getRegistration(), jsonToCompare.getRegistration(), msgError("Registration Date")),
				...
				() -> assertEquals(String.format("%s, %s", lastName, firstName), jsonToCompare.getFullName(), msgError("Full name")),
				...
				() -> assertEquals(player.getRegistration(), jsonToCompare2.getRegistration(), msgError("Registration Date")),
				...
				() -> assertEquals(String.format("%s, %s", lastName, firstName), jsonToCompare2.getFullName(), msgError("Full name")),
				...
				() -> assertEquals(playerToCompare, playerToCompare2, msgError("playerToCompare and playerToCompare2"))
		);
	...
	public void testJsonToPlayer() {
		...
		assertAll(
				() -> assertEquals(playerToCompare.getEmail(), playerJson.getEmail(), msgError("E-mail")),
	...
	public void testGettersSettersPlayerJson() {
		...
		assertAll(
				() -> assertEquals(id, playerJson.getId(), msgError("Id")),
				...
				() -> assertEquals(String.format("%s, %s", lastName, firstName), playerJson.getFullName(), msgError("Full name")),
	...
	public void testGettersSettersPlayer() {
		...
		assertAll(
				() -> assertEquals(id, player.getId(), msgError("Id")),
